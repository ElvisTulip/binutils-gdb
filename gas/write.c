...
compress_debug (bfd *abfd, asection *sec, void *xxx ATTRIBUTE_UNUSED)
{
  ...
  header[header_size - 1] = uncompressed_size; uncompressed_size >>= 8;
  header[header_size - 2] = uncompressed_size; uncompressed_size >>= 8;
  header[header_size - 3] = uncompressed_size; uncompressed_size >>= 8;
  header[header_size - 4] = uncompressed_size; uncompressed_size >>= 8;
  header[header_size - 5] = uncompressed_size; uncompressed_size >>= 8;
  header[header_size - 6] = uncompressed_size; uncompressed_size >>= 8;
  header[header_size - 7] = uncompressed_size; uncompressed_size >>= 8;
  header[header_size - 8] = uncompressed_size;
